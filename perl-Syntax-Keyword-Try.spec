...
%prep
%setup -q -n Syntax-Keyword-Try-0.29
cd %{_builddir}/Syntax-Keyword-Try-0.29
...
cp %{_builddir}/Syntax-Keyword-Try-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Syntax-Keyword-Try/df9f2d29a10846c30925e18b0273e53356f88a79 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Syntax-Keyword-Try/df9f2d29a10846c30925e18b0273e53356f88a79
