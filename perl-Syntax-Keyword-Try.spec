...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Syntax-Keyword-Try-0.28.tar.gz
...
%prep
%setup -q -n Syntax-Keyword-Try-0.28
cd %{_builddir}/Syntax-Keyword-Try-0.28
...
cp %{_builddir}/Syntax-Keyword-Try-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Syntax-Keyword-Try/1a0db8ae53618717535b6c54006100fc3e919f87 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Syntax-Keyword-Try/1a0db8ae53618717535b6c54006100fc3e919f87
